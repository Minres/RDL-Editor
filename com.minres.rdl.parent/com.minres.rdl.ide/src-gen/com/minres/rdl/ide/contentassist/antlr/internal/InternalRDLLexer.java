...
public class InternalRDLLexer extends Lexer {
    ...
    public final void mT__98() throws RecognitionException {
        try {
            int _type = T__98;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDL.g:99:7: ( 'rw' )
            // InternalRDL.g:99:9: 'rw'
            {
            match("rw"); 
    ...
    public final void mT__99() throws RecognitionException {
        try {
            int _type = T__99;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDL.g:100:7: ( 'wr' )
            // InternalRDL.g:100:9: 'wr'
            {
            match("wr"); 
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDL.g:7646:17: ( ( '/*' ( options {greedy=false; } : . )* '*/' | '<%' ( options {greedy=false; } : . )* '%>' | '(' ( options {greedy=false; } : . )* ')' ) )
            // InternalRDL.g:7646:19: ( '/*' ( options {greedy=false; } : . )* '*/' | '<%' ( options {greedy=false; } : . )* '%>' | '(' ( options {greedy=false; } : . )* ')' )
            {
            // InternalRDL.g:7646:19: ( '/*' ( options {greedy=false; } : . )* '*/' | '<%' ( options {greedy=false; } : . )* '%>' | '(' ( options {greedy=false; } : . )* ')' )
            int alt7=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt7) {
                case 1 :
                    // InternalRDL.g:7646:20: '/*' ( options {greedy=false; } : . )* '*/'
                    {
                    match("/*"); 

                    // InternalRDL.g:7646:25: ( options {greedy=false; } : . )*
                    loop4:
                    do {
                        int alt4=2;
                    ...
                    break;
                case 2 :
                    // InternalRDL.g:7646:62: '<%' ( options {greedy=false; } : . )* '%>'
                    {
                    match("<%"); 

                    // InternalRDL.g:7646:67: ( options {greedy=false; } : . )*
                    loop5:
                    do {
                        int alt5=2;
                    ...
                    break;
                case 3 :
                    // InternalRDL.g:7646:104: '(' ( options {greedy=false; } : . )* ')'
                    {
                    match('('); 
                    // InternalRDL.g:7646:108: ( options {greedy=false; } : . )*
                    loop6:
                    do {
                        int alt6=2;
    ...
    public final void mRULE_NUM() throws RecognitionException {
        try {
            int _type = RULE_NUM;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDL.g:7650:10: ( ( ( '0' .. '9' )+ '\\'b' ( '0' | '1' | '_' )+ | ( '0' .. '9' )+ '\\'o' ( '0' .. '7' | '_' )+ | ( '0' .. '9' )+ '\\'h' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+ | ( '0' .. '9' )+ '\\'d' ( '0' .. '9' | '_' )+ | '0x' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ | ( '0' .. '9' )+ ) )
            // InternalRDL.g:7650:12: ( ( '0' .. '9' )+ '\\'b' ( '0' | '1' | '_' )+ | ( '0' .. '9' )+ '\\'o' ( '0' .. '7' | '_' )+ | ( '0' .. '9' )+ '\\'h' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+ | ( '0' .. '9' )+ '\\'d' ( '0' .. '9' | '_' )+ | '0x' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ | ( '0' .. '9' )+ )
            {
            // InternalRDL.g:7650:12: ( ( '0' .. '9' )+ '\\'b' ( '0' | '1' | '_' )+ | ( '0' .. '9' )+ '\\'o' ( '0' .. '7' | '_' )+ | ( '0' .. '9' )+ '\\'h' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+ | ( '0' .. '9' )+ '\\'d' ( '0' .. '9' | '_' )+ | '0x' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ | ( '0' .. '9' )+ )
            int alt21=6;
            ...
            switch (alt21) {
                case 1 :
                    // InternalRDL.g:7650:13: ( '0' .. '9' )+ '\\'b' ( '0' | '1' | '_' )+
                    {
                    // InternalRDL.g:7650:13: ( '0' .. '9' )+
                    int cnt11=0;
                    loop11:
                    do {
                        int alt11=2;
                    ...
                    break;
                case 2 :
                    // InternalRDL.g:7650:46: ( '0' .. '9' )+ '\\'o' ( '0' .. '7' | '_' )+
                    {
                    // InternalRDL.g:7650:46: ( '0' .. '9' )+
                    int cnt13=0;
                    loop13:
                    do {
                        int alt13=2;
                    ...
                    break;
                case 3 :
                    // InternalRDL.g:7650:80: ( '0' .. '9' )+ '\\'h' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+
                    {
                    // InternalRDL.g:7650:80: ( '0' .. '9' )+
                    int cnt15=0;
                    loop15:
                    do {
                        int alt15=2;
                    ...
                    // InternalRDL.g:7650:98: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+
                    int cnt16=0;
                    loop16:
                    do {
                        int alt16=2;
                    ...
                    break;
                case 4 :
                    // InternalRDL.g:7650:132: ( '0' .. '9' )+ '\\'d' ( '0' .. '9' | '_' )+
                    {
                    // InternalRDL.g:7650:132: ( '0' .. '9' )+
                    int cnt17=0;
                    loop17:
                    do {
                        int alt17=2;
                    ...
                    break;
                case 5 :
                    // InternalRDL.g:7650:166: '0x' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+
                    {
                    match("0x"); 

                    // InternalRDL.g:7650:171: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+
                    int cnt19=0;
                    loop19:
                    do {
                        int alt19=2;
    ...
    public final void mRULE_STR() throws RecognitionException {
        try {
            int _type = RULE_STR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDL.g:7652:10: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalRDL.g:7652:12: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalRDL.g:7652:16: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop22:
            do {
                int alt22=3;
                ...
                switch (alt22) {
            	case 1 :
            	    // InternalRDL.g:7652:17: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
    ...
    static final String[] DFA23_transitionS = {
            ...
            "\1\145\10\uffff\1\144",
            "\1\146\6\uffff\1\147",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\1\152\13\44\1\151\11\44\1\150\3\44",
            "\1\154",
            "\1\155",
            "\1\156",
            "\1\157",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\14\44\1\160\15\44",
            "\1\163\20\uffff\1\162",
            "\1\164",
            "\1\165\4\uffff\1\166",
            "\1\167",
            ...
            "\1\u00cf",
            "\1\u00d0",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\1\u00d3\4\44\1\u00d1\20\44\1\u00d2\3\44",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44",
            "\1\u00d6",
            "\1\u00d7",
            "\1\u00d8",
            ...
            "\1\u0107",
            "\1\u0108",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\13\44\1\u0109\16\44",
            "\1\u010b",
            "\1\u010c",
            "\1\u010d",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44",
            ...
            "\1\u012b",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\22\44\1\u012f\1\u0130\1\44\1\u012e\1\u012d\3\44",
            "\1\u0132",
            "\1\u0133\20\uffff\1\u0134",
            "\1\u0135",
            "\1\u0136",
            ...
            "\1\u0139",
            "\1\u013a",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\4\44\1\u013c\7\44\1\u013b\15\44",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44",
            "\1\u013f",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\25\44\1\u0141\1\u0140\3\44",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44",
            "\1\u0144",
            "\1\u0145",
            "\1\u0146",
            ...
            "\1\u0177",
            "\1\u0178",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\22\44\1\u0179\7\44",
            "",
            "\1\u017b",
            "",
            "\12\44\7\uffff\32\44\4\uffff\1\u017c\1\uffff\26\44\1\u017d\3\44",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44",
            "\1\u0180",
            "",
            "\1\u0181",
            ...
            "\1\u01a5",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\1\44\1\u01a7\30\44",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\26\44\1\u01a9\3\44",
            "\1\u01ab",
            "",
            "",
            "",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\4\44\1\u01ac\25\44",
            "\1\u01ae",
            "\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44",
            "\1\u01b0",
            "\1\u01b1",
            ...
            "\1\u01f6",
            "\1\u01f7",
            "\12\44\7\uffff\27\44\1\u01f8\2\44\4\uffff\1\44\1\uffff\32\44",
            "\1\u01fa",
            "\1\u01fb",
            "\1\u01fc",
            "\1\u01fd",
